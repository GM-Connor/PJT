	...
	routine_schedule =    [
		...
		new Day( 
			...
			sets = [
				...
				new Set('75%', LoadType.WEIGHT, 5, 180),
				new Set('75%', LoadType.WEIGHT, 5, 180),
				new Set('75%', LoadType.WEIGHT, 5, 0)
			]
		),
		new Day( 
			gap  = 4,
	...
	routine_schedule =    [
		...
		new Day( 
			...
			sets = [
				...
				new Set('75%', LoadType.WEIGHT, 3, 180),
				new Set('75%', LoadType.WEIGHT, 3, 180),
				new Set('75%', LoadType.WEIGHT, 3, 0)
			]
		),
		new Day( 
			gap  = 3,
...
var PULLUP_50 = new Exercise(
	...
	routine_schedule =    [
		...
		new Day( 
			...
			sets = [
				new Set('', LoadType.BODY_WEIGHT, 16, 120),
				new Set('', LoadType.BODY_WEIGHT, 21, 120),
				new Set('', LoadType.BODY_WEIGHT, 16, 120),
				new Set('', LoadType.BODY_WEIGHT, 16, 120),
				new Set('+', LoadType.BODY_WEIGHT, 20, 0)
			]
		...
		new Day( 
			...
			sets = [
				...
				new Set('', LoadType.BODY_WEIGHT, 16, 120),
				new Set('', LoadType.BODY_WEIGHT, 16, 120),
				new Set('+', LoadType.BODY_WEIGHT, 21, 0)
			]
		),
...
var DIP_100 = new Exercise(
	...
	routine_schedule =    [
		...
		new Day( 
			gap  = 4,
			sets = [
				new Set('', LoadType.BODY_WEIGHT, 21, 60),
